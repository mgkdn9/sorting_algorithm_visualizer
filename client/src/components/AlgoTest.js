    ...
    if (currentQuestion < 5) {
      ...
      return (
        <div style={container}>
          ...
          <h3 style={subtitle}>
            You got merge sort {userScore.bMerge ? "right" : "wrong"}
          </h3>
          <h3 style={subtitle}>
            You got quick sort {userScore.bQuick ? "right" : "wrong"}
          </h3>
          <h3 style={subtitle}>
            You got bubble sort {userScore.bBubble ? "right" : "wrong"}
          </h3>
          <h3 style={subtitle}>
            You got heap sort {userScore.bHeap ? "right" : "wrong"}
          </h3>
          {props.user ? (
            <Button style={button} onClick={postScore}>
              Save Score
            </Button>
          ) : (
            <p style={question}>
              Make sure you are signed in or you score will not be saved
            </p>
          )}
